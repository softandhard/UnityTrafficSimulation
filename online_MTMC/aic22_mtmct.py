...
def run_mtmc():
    ...
    result_txt = open(output_dir + 'mtmc22_%s_%s.txt' % (opt.feat_ext_name, opt.avg_type), 'w')
        ...
        for i in range(0, np.max(f_nums) + 1):
            ...
            if cam == 'c006':
                if i <= 374:
                    ...
                    temp_align[cam][i] = i - 8
                elif 452 <= i <= 545:
                    temp_align[cam][i] = i - 23
                elif 598 <= i <= 1364:
                    temp_align[cam][i] = i - 75
                elif 1370 <= i <= 1628:
                    temp_align[cam][i] = i - 140
                elif 1644 <= i <= 1663:
                    temp_align[cam][i] = i - 155
                elif 1677 <= i <= 1709:
                    temp_align[cam][i] = i - 168
                elif 1781 <= i <= 1802:
                    temp_align[cam][i] = i - 239
                elif 1804 <= i <= 1912:
                    temp_align[cam][i] = i - 240
                elif 1914 <= i <= 1915:
                    temp_align[cam][i] = i - 241
                elif i == 1919:
                    temp_align[cam][i] = i - 244
                elif 2087 <= i:
                    temp_align[cam][i] = i - 412

            elif cam == 'c007':
                if i <= 214:
                    temp_align[cam][i] = i + 1
                elif 218 <= i <= 884:
                    temp_align[cam][i] = i - 2
                elif 948 <= i <= 1462:
                    temp_align[cam][i] = i - 65
                elif 1464 <= i <= 1467:
                    temp_align[cam][i] = i - 66
                elif 1471 <= i <= 1832:
                    temp_align[cam][i] = i - 69
                elif 1874 <= i <= 1920:
                    temp_align[cam][i] = i - 110
                elif 1931 <= i:
                    temp_align[cam][i] = i - 120
                ...
                if 7 <= i <= 353:
                    ...
                    temp_align[cam][i] = i - 54
                elif i == 1366:
                    temp_align[cam][i] = i - 56
                elif 1368 <= i <= 1371:
                    temp_align[cam][i] = i - 57
                elif 1375 <= i <= 1717:
                    temp_align[cam][i] = i - 60
                elif 1865 <= i:
                    temp_align[cam][i] = i - 207
    ...
    for fdx in range(0, np.max(f_nums) + 1):
        ...
        #         cv2.imwrite("C:/Users/cjh/Desktop/MTMCT/online_MTMC/outputs/img_result/{}/{}_{}.jpg".format(cam, global_id, fdx), draw_img)
