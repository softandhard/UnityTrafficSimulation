...
def run_mtmc():
    ...
    result_txt = open(output_dir + 'multi_all_mtmc_%s_%s.txt' % (opt.feat_ext_name, opt.avg_type), 'w')
    print("res==", output_dir + 'multi_all_mtmc_%s_%s.txt' % (opt.feat_ext_name, opt.avg_type))
    # Prepare others
