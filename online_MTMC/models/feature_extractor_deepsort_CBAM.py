...
from online_MTMC.models.deepsort_CBAM_model import Net, AttentionNet
...
class FeatureExtractor(nn.Module):
    def __init__(self, model_name, avg_type, pretrained_dir):
        ...
        print("model=", '%s_%s_60.t7' % (model_name, avg_type))
        # Load preliminary weight
        self.load_param(pretrained_dir + '%s_%s_60.t7' % (model_name, avg_type))
