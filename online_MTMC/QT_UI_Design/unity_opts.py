...
class Opts:
    def __init__(self):
        ...
        self.parser.add_argument('--det_name', type=str, default='yolov7-w6')
        self.parser.add_argument('--det_weights', type=str, default='C:/Users/cjh/Desktop/MTMCT/online_MTMC/preliminary/det_weights/')
        ...
        self.parser.add_argument('--scene_feat_ext_name', type=str, default='attention_net')
        self.parser.add_argument('--feat_ext_weights', type=str, default='C:/Users/cjh/Desktop/MTMCT/online_MTMC/preliminary/feat_ext_weights/')
        self.parser.add_argument('--scene_feat_ext_weights', type=str, default='C:/Users/cjh/Desktop/MTMCT/online_MTMC/preliminary/feat_ext_weights/')
        ...
        self.parser.add_argument("--max_time_differ", type=int, default=10)
        ...
        self.parser.add_argument('--cluster_merge_pattern', type=str, default='minimal')
        self.parser.add_argument('--show_img', default=False, help='是否显示仿真图像')
