...
class Opts:
    def __init__(self):
        ...
        self.parser.add_argument('--feat_ext_name', type=str, default='attention_net')
        ...
        self.parser.add_argument('--scene_feat_ext_weights', type=str, default='./preliminary/feat_ext_weights/attention_net.t7')
