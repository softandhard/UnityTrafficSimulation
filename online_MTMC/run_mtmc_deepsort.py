...
from models.feature_extractor_deepsort import FeatureExtractor
...
def run_mtmc():
    ...
    result_txt = open(output_dir + 'deepsort_mtmc_%s_%s.txt' % (opt.feat_ext_name, opt.avg_type), 'w')
