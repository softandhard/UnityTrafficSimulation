...
# python3 eval.py < ground_truth > < prediction > --dstype < dstype >
# test_labels : 需要测试的数据集的真实值
# predicted_labels : 追踪算法在测试数据集上生成的追踪结果

# C:/Users/cjh/Desktop/MTMCT/eval/gt/ground_truth_test.txt
# C:/Users/cjh/Desktop/MTMCT/eval/AIC19_S02.txt

def get_args():
    parser = ArgumentParser(add_help=False, usage=usageMsg())
    parser.add_argument("--data", nargs=2, default=["C:/Users/cjh/Desktop/MTMCT/eval/gt/ground_truth_test.txt",
                                                    "C:/Users/cjh/Desktop/MTMCT/online_MTMC/outputs/mask-rcnn/mtmc_resnet101_ibn_a_gap.txt"],
                        help="Path to <test_labels> <predicted_labels>.")
    parser.add_argument('--help', action='help', help='Show this help message and exit')
    parser.add_argument('-m', '--mread', action='store_true', help="Print machine readable results (JSON).")
    parser.add_argument('-ds', '--dstype', type=str, default='test', help="Data set type: train, validation or test.")
    parser.add_argument('-rd', '--roidir', type=str,
                        default='C:/Users/cjh/Desktop/MTMCT/online_MTMC/preliminary/roi_test',
...
def print_results(summary, mread=False):
    ...
    formatters = {'idf1': '{:2.2f}'.format,
                  ...
                  'idr': '{:2.2f}'.format,
                  'mota': '{:2.2f}'.format,
                  'num_switches': '{:2.0f}'.format}

    summary = summary[['idf1', 'idp', 'idr', 'mota', 'num_switches']]
    summary['idp'] *= 100
    summary['idr'] *= 100
    summary['idf1'] *= 100
    summary['mota'] *= 100
    summary['num_switches'] = summary['num_switches'].astype(int)
...
def eval(test, pred, **kwargs):
    ...
    dstype = kwargs.pop('dstype', 'test')
    roidir = kwargs.pop('roidir', 'C:/Users/cjh/Desktop/MTMCT/online_MTMC/preliminary/roi_test/')
